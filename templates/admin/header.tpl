		...
		<div id="header" class="container_12">
			...
			<div id="main_menu" class="grid_9">
				<ul>
					...
					<li><a href="shipping_delivery.php" <?php if (in_array(basename($_SERVER['PHP_SELF']), array('shipping_delivery.php', 'shipping_details.php'))) echo 'class="current"'; ?>>Shipping delivery</a></li>
